...
func ReflectCase() {
	...
	listUser := []user{
		{ID: 1, Name: "nick", Hobby: []string{"篮球1", "羽毛球1"}},
		{ID: 2, Name: "nick2", Hobby: []string{"篮球2", "羽毛球2"}},
		{ID: 3, Name: "nick3", Hobby: []string{"篮球3", "羽毛球3"}},
	}
...
func copy(dest interface{}, source interface{}) error {
	...
	if dValue.Kind() != reflect.Struct {
		return errors.New("目标对象必须为struct或struct的指针")
	}
